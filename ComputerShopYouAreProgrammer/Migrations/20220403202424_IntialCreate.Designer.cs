...
namespace ComputerShopYouAreProgrammer.Migrations
{
    ...
    [Migration("20220403202424_IntialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComputerShopDatabaseImplement.Models.Consignment", b =>
                {
                    ...
                    b.Property<string>("СonsignmentName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ComputerShopDatabaseImplement.Models.ConsignmentOrder", b =>
                {
                    b.HasOne("ComputerShopDatabaseImplement.Models.Order", "Order")
                        .WithMany("СonsignmentOrders")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ComputerShopDatabaseImplement.Models.Consignment", "Сonsignment")
                        .WithMany("СonsignmentOrders")
            ...
            modelBuilder.Entity("ComputerShopDatabaseImplement.Models.FinalProduct", b =>
                {
                    b.HasOne("ComputerShopDatabaseImplement.Models.Component", null)
                        .WithMany("FinalProducts")
                        .HasForeignKey("ComponentId");

                    b.HasOne("ComputerShopDatabaseImplement.Models.Employee", null)
                        .WithMany("FinalProducts")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("ComputerShopDatabaseImplement.Models.PersonalBuild", "PersonalBuild")
                        .WithMany()
                        .HasForeignKey("PersonalBuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ComputerShopDatabaseImplement.Models.OrderRequest", b =>
                {
                    ...
                    b.HasOne("ComputerShopDatabaseImplement.Models.Request", null)
                        .WithMany("OrderRequests")
            ...
            modelBuilder.Entity("ComputerShopDatabaseImplement.Models.Consignment", b =>
                {
                    b.Navigation("СonsignmentOrders");
